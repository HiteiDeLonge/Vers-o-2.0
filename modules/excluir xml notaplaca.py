...
dados = pd.read_excel(r'C:\Users\Log20-2\Desktop\Versão 2.0\planilhas\notas.xlsx')

# Extrair os números da coluna "numero"
numeros_planilha = set(dados['Número'].tolist())

# Diretório onde estão os arquivos XML
diretorio_xml = r'C:\Users\Log20-2\Desktop\Versão 2.0\Notas\xmls NF-e'
...
if not df_log.empty:
    ...
    messagebox.showinf=("Log de notas encontradas salvo com sucesso.","Notas Excluidas com sucesso")
else:
